...
from sciekipolskie.views import RepresentList, AddNewWorkerView, DetailsAboutWorkerView, AddNewTaskView
...
urlpatterns = [
    ...
    path('task/new/<int:id_of_worker>/', AddNewTaskView.as_view(), name='add_new_task'),
]
